...
extern "C" DECLSPEC_EXPORT char *__cdecl TetrisAI(int overfield[], int field[], int field_w, int field_h, int b2b, int combo, char next[], char hold, bool curCanHold, char active, int x, int y, int spin, bool canhold, bool can180spin, int upcomeAtt, int comboTable[], int maxDepth, int level, int player)
{
    ...
    *srs_pc->search_config() = *srs_ai.search_config();
    ...
    //GEN: 18
    //SCORE: 1612.40
    //srs_ai.ai_config()->param = { 29.824468814733521071502764244, 302.112804118846781875618034974, 386.308131434432027617731364444, 202.724922154854056088879588060, 379.489635473135024312796304002, 60.175200223697203227857244201, 0.693394890739895464193409680, -261.072755892654186027357354760, -120.052043918298167568536882754, -62.182832634215820633016846841, 8.019556959172870591601167689, 513.149573063436491793254390359, 161.544685571081231501011643559, 0.571142965331783547533461842, 0.068681879338192530770612620, -27.904919346499799104321937193, -13.935078740715377776382410957, -24.977320079384302431435571634, -66.277346562317731581970292609, -55.654292257234061480630771257, 14.346966489383685683378644171, 1.313441037407632849820515730, 0.067657589910524201792796362, -4.689392081048645799512541998, 6.878370823780528553470503539, 3.676492092508083953106279296, 0.886916854188605330300276819, 91.743688044224086297617759556, 0.341510310661717997327002649 };
